...
async function listCourses(req, res) {
  try {
    ...
    console.error("Learn list courses error:", error);
    res.status(500).json({ error: "Failed to load learn catalog." });
  }
}
...
async function getLesson(req, res) {
  try {
    ...
    console.error("Learn get lesson error:", error);
...
async function getLessonProgress(req, res) {
  try {
    ...
    console.error("Learn lesson progress error:", error);
...
async function submitStep(req, res) {
  try {
    ...
    console.error("Learn submit step error:", error);
...
async function complete(req, res) {
  try {
    ...
    console.error("Learn complete lesson error:", error);
...
async function search(req, res) {
  try {
    ...
    res.status(500).json({ error: "Failed to search learn content." });
  }
}
