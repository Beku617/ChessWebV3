...
export async function fetchLearnCatalog(params: {
  ...
  const response = await fetch(`${API_URL}/api/learn-mn/courses${query}`, {
    credentials: "include",
  });
...
export async function fetchLearnCourse(courseSlug: string) {
  const response = await fetch(`${API_URL}/api/learn-mn/courses/${courseSlug}`, {
    credentials: "include",
  });
...
export async function fetchLearnLesson(
  ...
  const response = await fetch(
    `${API_URL}/api/learn-mn/lessons/${courseSlug}/${lessonSlug}`,
    {
      credentials: "include",
    },
  );
...
export async function fetchLearnProgressSummary(): Promise<LearnSummary> {
  const response = await fetch(`${API_URL}/api/learn-mn/progress/me`, {
    credentials: "include",
  });
...
export async function fetchLearnLessonProgress(
  ...
  const response = await fetch(
    `${API_URL}/api/learn-mn/progress/${courseSlug}/${lessonSlug}`,
    {
      credentials: "include",
    },
  );
...
export async function submitLearnLessonStep(
  ...
  const response = await fetch(
    `${API_URL}/api/learn-mn/progress/${courseSlug}/${lessonSlug}/step`,
    {
      method: "POST",
      credentials: "include",
...
export async function completeLearnLesson(
  ...
  const response = await fetch(
    `${API_URL}/api/learn-mn/progress/${courseSlug}/${lessonSlug}/complete`,
    {
      method: "POST",
      credentials: "include",
    },
...
export async function searchLearnContent(query: string) {
  ...
  const response = await fetch(`${API_URL}/api/learn-mn/search${qs}`, {
    credentials: "include",
  });
  return parseResponse(response);
}
...
export async function fetchLearnPairMapping(
  ...
  const response = await fetch(`${API_URL}/api/learn-mn/pair/${pairId}`, {
    credentials: "include",
  });
