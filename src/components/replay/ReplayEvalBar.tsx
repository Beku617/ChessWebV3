...
export function ReplayEvalBar({
  ...
  const displayLabel = evalLabel === "—" || evalLabel === "â€”" ? "0.00" : evalLabel;

  if (orientation === "vertical") {
    return (
      <div className="flex h-full flex-col items-center">
        <span className="mb-1 text-[10px] uppercase tracking-wide text-gray-500 dark:text-gray-400">
          {t("analysis.engineEvaluation", "Engine evaluation")}
        </span>
        <div
          className={`mb-1 rounded px-1.5 py-1 text-center text-[10px] font-bold ${
            isWhiteAdvantage
        ...
        <div className="relative w-5 flex-1 overflow-hidden rounded border border-gray-400 bg-slate-200 dark:border-gray-500 dark:bg-slate-700">
          <div
